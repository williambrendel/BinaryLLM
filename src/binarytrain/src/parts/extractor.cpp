// ============================================================================
// binarytrain/src/parts/extractor.cpp
// ============================================================================
...
std::size_t pruned_count(
  ...
  return binaryoptim::adaptive_prune_count(values);
}
...
std::size_t run_peel_iteration(
  ...
  for (std::size_t L : {std::size_t{7}, std::size_t{6}, std::size_t{5},
...
PartDictionary PartExtractor::finalize() {
  ...
  // Whole atoms: length-bound + cascade prune on frequency.
  {
    ...
    const std::size_t k = binaryoptim::adaptive_prune_count(freqs);
