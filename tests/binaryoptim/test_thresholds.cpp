// ============================================================================
// tests/binaryoptim/test_thresholds.cpp
//
// Doctest coverage for the threshold utilities. The composite cascade
// (adaptive_prune_count) is covered in detail in test_adaptive_prune.cpp;
// this file owns the per-utility behavior (entropy_effective_count,
// gap_ratio_effective_count) plus a few composite spot checks.
// ============================================================================
...
using binaryoptim::adaptive_prune_count;
using binaryoptim::adaptive_prune_threshold;
using binaryoptim::entropy_effective_count;
using binaryoptim::gap_ratio_effective_count;
using binaryoptim::kNoMaxCutIndex;
