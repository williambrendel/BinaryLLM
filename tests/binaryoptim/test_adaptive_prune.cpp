// ============================================================================
// tests/binaryoptim/test_adaptive_prune.cpp
//
// Tests for the four utilities and the canonical composite
// adaptive_prune in binaryoptim/thresholds.
//
// Coverage:
...
using binaryoptim::elbow_effective_count;
using binaryoptim::kElbowSig;
using binaryoptim::kMMFactor;
using binaryoptim::scaled_mm_effective_count;
